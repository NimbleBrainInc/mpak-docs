...
<CardGrid>
  <LinkCard title="Manifest Reference" description="Full manifest.json documentation" href="/bundles/manifest" />
  <LinkCard title="GitHub Action" description="Complete action configuration" href="/bundles/github-action" />
  <LinkCard title="Multi-Platform Builds" description="Build for macOS, Linux, and more" href="/bundles/multi-platform" />
