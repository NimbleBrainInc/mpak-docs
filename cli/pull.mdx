...
| `--json` | Output download info as JSON (doesn't download) | Download |
...
Downloading @nimblebraininc/echo@1.0.0 (darwin-arm64)...
Downloaded to ./nimblebraininc-echo-1.0.0.mcpb (2.1 KB)
SHA256: abc123...
```
